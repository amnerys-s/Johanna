...
namespace johanna
{
    public class Conexion
    {
        ...
        {
            SqlConnection conn = new SqlConnection(@"Data Source=A19A68683\SQLEXPRESS;Initial Catalog=LAREAL;Integrated Security=True");
            
            return conn;
        }
         public class creaa_ticket 
        {
            ...
            {
                string LineEncavesado = "Artículo         Cant            P.Unit        Total";   // agrega lineas de  encabezados
            ...
            public void TextoDerecha(string par1)
            {
                ...
                max = 60 - par1.Length;                     // obtiene la cantidad de espacios para llegar a 40
                for (int i = 0; i < max; i++)
                {
